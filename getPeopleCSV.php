        ...
        foreach($orcidids as $orcidid){
            ...
            if(!is_null($person["affiliation-group"]))
                if (count($person["affiliation-group"])>0)
                {
                    ...
                    $role = isset($person["affiliation-group"][0]["summaries"][0]["employment-summary"]["role-title"]) ? $person["affiliation-group"][0]["summaries"][0]["employment-summary"]["role-title"] : "";
            ...
            if($i==2) // just a few record do test
                    break;
        }
        return $list;
    }
